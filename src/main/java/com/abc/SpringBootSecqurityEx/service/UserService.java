...
import com.abc.SpringBootSecqurityEx.util.NotFoundException;
...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        adminUser.setUserName("Hafiz");
        adminUser.setPassword(getEncodedPassword("114588"));
        adminUser.setUserFirstName("adm1in");
        adminUser.setUserLastName("admin1");
        adminUser.setEmail("admin11@gmail.com");
